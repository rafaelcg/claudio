...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders CLAUDIO_CALLER", () => {
    process.env["CLAUDIO_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode CLAUDIO_CALLER", () => {
    process.env["CLAUDIO_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown CLAUDIO_CALLER", () => {
    process.env["CLAUDIO_CALLER"] = "unknown"
