...
export const DEFAULT_THEMES: Record<string, ThemeJson> = {
  ...
  opencode,
  /** Alias of `opencode` theme — default for Claudio Code */
  claudio: opencode,
  orng,
...
export const { use: useTheme, provider: ThemeProvider } = createSimpleContext({
  ...
  init: (props: { mode: "dark" | "light" }) => {
    ...
    const [store, setStore] = createStore({
      ...
      active: (config.theme ?? kv.get("theme", "claudio")) as string,
      ready: false,
    })
    ...
    const values = createMemo(() => {
      return resolveTheme(store.themes[store.active] ?? store.themes.claudio ?? store.themes.opencode, store.mode)
    })
