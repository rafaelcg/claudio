export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'Claudio Code",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'Claudio Code a été téléchargée. Voulez-vous l'installer et redémarrer ?",
  ...
  "desktop.menu.help.documentation": "Documentation d'Claudio Code",
  ...
  "desktop.cli.error.sidecarMissing":
    "Le binaire de la CLI Claudio Code est manquant. Essayez de réinstaller l'application de bureau.",
