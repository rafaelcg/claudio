export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Claudio Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Claudio Code. ¿Quieres instalarla y reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentación de Claudio Code",
  ...
  "desktop.cli.error.sidecarMissing":
    "Falta el binario de la CLI de Claudio Code. Intenta reinstalar la aplicación de escritorio.",
