export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの Claudio Code を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "Claudio Code のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.menu.help.documentation": "Claudio Code ドキュメント",
  ...
  "desktop.cli.error.sidecarMissing":
    "Claudio Code CLI のバイナリが見つかりません。デスクトップアプリを再インストールしてみてください。",
