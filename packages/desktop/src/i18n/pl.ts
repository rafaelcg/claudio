export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji Claudio Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} Claudio Code. Czy chcesz ją zainstalować i uruchomić ponownie?",
  ...
  "desktop.menu.help.documentation": "Dokumentacja Claudio Code",
  ...
  "desktop.cli.error.sidecarMissing":
    "Brakuje pliku binarnego Claudio Code CLI. Spróbuj ponownie zainstalować aplikację na komputer.",
