export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av Claudio Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av Claudio Code er lastet ned. Vil du installere den og starte på nytt?",
  ...
  "desktop.menu.help.documentation": "Claudio Code Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "Claudio Code CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
