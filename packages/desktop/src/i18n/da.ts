export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Claudio Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Claudio Code er blevet downloadet. Vil du installere den og genstarte?",
  ...
  "desktop.menu.help.documentation": "Claudio Code Dokumentation",
  ...
  "desktop.cli.error.sidecarMissing": "Claudio Code CLI-binærfil mangler. Prøv at geninstallere desktop-appen.",
