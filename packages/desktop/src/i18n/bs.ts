export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju Claudio Code-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} Claudio Code-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
  ...
  "desktop.menu.help.documentation": "Claudio Code Dokumentacija",
  ...
  "desktop.cli.error.sidecarMissing":
    "Nedostaje binarna datoteka Claudio Code CLI-a. Pokušaj ponovo instalirati desktop aplikaciju.",
