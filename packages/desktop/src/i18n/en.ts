export const dict = {
  ...
  "desktop.menu.help.documentation": "Claudio Code Documentation",
  ...
  "desktop.updater.none.message": "You are already using the latest version of Claudio Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of Claudio Code has been downloaded, would you like to install it and relaunch?",
  ...
  "desktop.cli.error.sidecarMissing": "Claudio Code CLI binary is missing. Try reinstalling the desktop app.",
