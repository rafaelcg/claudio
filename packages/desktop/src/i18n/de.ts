export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von Claudio Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von Claudio Code wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
  ...
  "desktop.cli.error.sidecarMissing":
    "Das Claudio Code CLI-Binary fehlt. Versuchen Sie, die Desktop-App neu zu installieren.",
