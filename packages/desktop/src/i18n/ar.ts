export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من Claudio Code",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من Claudio Code، هل ترغب في تثبيته وإعادة تشغيله؟",
  ...
  "desktop.menu.help.documentation": "وثائق Claudio Code",
  ...
  "desktop.cli.error.sidecarMissing": "ملف Claudio Code CLI الثنائي مفقود. حاول إعادة تثبيت تطبيق سطح المكتب.",
