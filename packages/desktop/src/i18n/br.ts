export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do Claudio Code",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do Claudio Code foi baixada. Você gostaria de instalá-la e reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentação do Claudio Code",
  ...
  "desktop.cli.error.sidecarMissing":
    "O binário da CLI do Claudio Code está ausente. Tente reinstalar o aplicativo de desktop.",
