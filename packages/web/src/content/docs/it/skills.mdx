...
- Config di progetto: `.claudio/skills/<name>/SKILL.md`
...
Carica qualsiasi `skills/*/SKILL.md` corrispondente in `.claudio/` e qualsiasi `.claude/skills/*/SKILL.md` o `.agents/skills/*/SKILL.md` corrispondente lungo il percorso.
...
Crea `.claudio/skills/git-release/SKILL.md` cosi':
