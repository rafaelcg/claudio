...
- Configuration du projet : `.claudio/skills/<name>/SKILL.md`
...
Il charge tout `skills/*/SKILL.md` correspondant dans `.claudio/` et tout `.claude/skills/*/SKILL.md` ou `.agents/skills/*/SKILL.md` correspondant en cours de route.
...
Créez `.claudio/skills/git-release/SKILL.md` comme ceci :
