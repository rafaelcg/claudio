...
- إعدادات المشروع: `.claudio/skills/<name>/SKILL.md`
...
ويحمّل أي ملفات مطابقة لـ `skills/*/SKILL.md` داخل `.claudio/` وأي ملفات مطابقة لـ `.claude/skills/*/SKILL.md` أو `.agents/skills/*/SKILL.md` على طول الطريق.
...
أنشئ `.claudio/skills/git-release/SKILL.md` بهذا الشكل:
