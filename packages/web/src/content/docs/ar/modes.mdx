...
- `edit` - لا يمكن تعديل الملفات الموجودة، باستثناء الملفات الموجودة في `.claudio/plans/*.md` لتفصيل الخطة نفسها
...
أنشئ ملفات الأوضاع في `.claudio/modes/` لأوضاع خاصة بالمشروع أو في `~/.config/opencode/modes/` لأوضاع عالمية:
