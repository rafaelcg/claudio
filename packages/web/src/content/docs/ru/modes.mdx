...
- `edit` – невозможно изменить существующие файлы, за исключением файлов, расположенных по адресу `.claudio/plans/*.md`, для детализации самого плана.
...
Создайте файлы режимов в `.claudio/modes/` для режимов, специфичных для проекта, или в `~/.config/opencode/modes/` для глобальных режимов:
