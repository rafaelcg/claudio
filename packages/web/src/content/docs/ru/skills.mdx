...
- Конфигурация проекта: `.claudio/skills/<name>/SKILL.md`
...
Он загружает все соответствующие `skills/*/SKILL.md` в `.claudio/` и все соответствующие `.claude/skills/*/SKILL.md` или `.agents/skills/*/SKILL.md` по пути.
...
Создайте `.claudio/skills/git-release/SKILL.md` следующим образом:
