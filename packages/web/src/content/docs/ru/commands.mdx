...
Создайте `.claudio/commands/test.md`:

```md title=".claudio/commands/test.md"
---
...
- Для каждого проекта: `.claudio/commands/`
...
```md title=".claudio/commands/component.md"
---
...
```md title=".claudio/commands/create-file.md"
---
...
```md title=".claudio/commands/analyze-coverage.md"
---
...
```md title=".claudio/commands/review-changes.md"
---
...
```md title=".claudio/commands/review-component.md"
---
