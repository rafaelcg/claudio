...
- `.claudio/plugins/` - Complementos a nivel de proyecto
...
4. Directorio de complementos del proyecto (`.claudio/plugins/`)
...
```json title=".claudio/package.json"
{
  "dependencies": {
    "shescape": "^2.1.0"
  }
...
```ts title=".claudio/plugins/my-plugin.ts"
...
```js title=".claudio/plugins/example.js"
...
import type { Plugin } from "@claudio-code/plugin"
...
```js title=".claudio/plugins/notification.js"
...
```javascript title=".claudio/plugins/env-protection.js"
...
```javascript title=".claudio/plugins/inject-env.js"
...
```ts title=".claudio/plugins/custom-tools.ts"
import { type Plugin, tool } from "@claudio-code/plugin"
...
```ts title=".claudio/plugins/compaction.ts"
import type { Plugin } from "@claudio-code/plugin"
...
```ts title=".claudio/plugins/custom-compaction.ts"
import type { Plugin } from "@claudio-code/plugin"
