...
- Configuración del proyecto: `.claudio/skills/<name>/SKILL.md`
...
Carga cualquier `skills/*/SKILL.md` coincidente en `.claudio/` y cualquier `.claude/skills/*/SKILL.md` o `.agents/skills/*/SKILL.md` coincidente a lo largo del camino.
...
Crea `.claudio/skills/git-release/SKILL.md` así:
