...
- `edit` - No se pueden modificar archivos existentes, excepto los archivos ubicados en `.claudio/plans/*.md` para detallar el plan en sí.
...
Cree archivos de modo en `.claudio/modes/` para modos específicos del proyecto o `~/.config/opencode/modes/` para modos globales:
