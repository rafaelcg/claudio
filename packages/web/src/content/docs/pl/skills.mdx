...
Ładuje po drodze dowolne pasujące `skills/*/SKILL.md` w `.claudio/` i dowolne pasujące `.claude/skills/*/SKILL.md` lub `.agents/skills/*/SKILL.md`.
...
Utwórz `.claudio/skills/git-release/SKILL.md` w ten sposób:
