...
- 프로젝트 구성: `.claudio/skills/<name>/SKILL.md`
...
그것은 `skills/*/SKILL.md`에 있는 어떤 어울리는 `.claudio/` 및 어떤 어울리는 `.claude/skills/*/SKILL.md` 또는 `.agents/skills/*/SKILL.md`를 방법 적재합니다.
...
이처럼 `.claudio/skills/git-release/SKILL.md` 만들기:
