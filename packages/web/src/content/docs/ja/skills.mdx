...
- プロジェクト設定: `.claudio/skills/<name>/SKILL.md`
...
途中で、一致する `skills/*/SKILL.md` を `.claudio/` に読み込み、一致する `.claude/skills/*/SKILL.md` または `.agents/skills/*/SKILL.md` を読み込みます。
...
次のように `.claudio/skills/git-release/SKILL.md` を作成します。
