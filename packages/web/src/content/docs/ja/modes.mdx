...
- `edit` - 計画自体の詳細を示す `.claudio/plans/*.md` にあるファイルを除き、既存のファイルを変更できません
- `patch` - パッチを適用できません
...
モードファイルをプロジェクト固有モードの場合は `.claudio/modes/` に、グローバルモードの場合は `~/.config/opencode/modes/` に作成します。
