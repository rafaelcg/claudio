...
- Project config: `.claudio/skills/<name>/SKILL.md`
...
Dabei werden passende `skills/*/SKILL.md` in `.claudio/` sowie passende Dateien unter `.claude/skills/*/SKILL.md` und `.agents/skills/*/SKILL.md` geladen.
...
Erstelle `.claudio/skills/git-release/SKILL.md` zum Beispiel so:
