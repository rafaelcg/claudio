...
- `edit` – Vorhandene Dateien können nicht geändert werden, mit Ausnahme der Dateien unter `.claudio/plans/*.md`, um den Plan selbst detailliert darzustellen
...
Erstellen Sie Modusdateien in `.claudio/modes/` für projektspezifische Modi oder `~/.config/opencode/modes/` für globale Modi:
