...
```bash
export CLAUDIO_DISABLE_CLAUDE_CODE=1        # Disable all .claude support
export CLAUDIO_DISABLE_CLAUDE_CODE_PROMPT=1 # Disable only ~/.claude/CLAUDE.md
export CLAUDIO_DISABLE_CLAUDE_CODE_SKILLS=1 # Disable only .claude/skills
```
