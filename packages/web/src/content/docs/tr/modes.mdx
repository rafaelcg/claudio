...
- `edit` - Planın kendisini detaylandırmak için `.claudio/plans/*.md` adresinde bulunan dosyalar dışında mevcut dosyalar değiştirilemez
...
Projeye özel modlar için `.claudio/modes/` veya genel modlar için `~/.config/opencode/modes/`'de mod dosyaları oluşturun:
