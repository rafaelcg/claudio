...
- Proje konfigurasyonu: `.claudio/skills/<name>/SKILL.md`
...
Bu sirada `skills/*/SKILL.md` altindaki eslesen `.claudio/` dosyalarini ve `.claude/skills/*/SKILL.md` ya da `.agents/skills/*/SKILL.md` dosyalarini yukler.
...
`.claudio/skills/git-release/SKILL.md` dosyasini soyle olusturun:
