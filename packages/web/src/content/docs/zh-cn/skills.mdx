...
- 项目配置：`.claudio/skills/<name>/SKILL.md`
...
在此过程中，它会加载 `.claudio/` 中所有匹配的 `skills/*/SKILL.md`，以及匹配的 `.claude/skills/*/SKILL.md` 或 `.agents/skills/*/SKILL.md`。
...
创建 `.claudio/skills/git-release/SKILL.md`，内容如下：
