...
- การกำหนดค่าโครงการ: `.claudio/skills/<name>/SKILL.md`
...
โดยจะโหลด `skills/*/SKILL.md` ที่ตรงกันใน `.claudio/` และ `.claude/skills/*/SKILL.md` หรือ `.agents/skills/*/SKILL.md` ที่ตรงกันตลอดทาง
...
สร้าง `.claudio/skills/git-release/SKILL.md` แบบนี้:
