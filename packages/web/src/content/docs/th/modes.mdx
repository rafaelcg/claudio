...
- `edit` - ​​ไม่สามารถแก้ไขไฟล์ที่มีอยู่ได้ ยกเว้นไฟล์ที่อยู่ใน `.claudio/plans/*.md` เพื่อดูรายละเอียดแผนงาน
...
สร้างไฟล์โหมดใน `.claudio/modes/` สำหรับโหมดเฉพาะโครงการหรือ `~/.config/opencode/modes/` สำหรับโหมดทั่วโลก:
