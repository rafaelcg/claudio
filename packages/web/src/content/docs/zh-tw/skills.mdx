...
- 專案設定：`.claudio/skills/<name>/SKILL.md`
...
在此過程中，它會載入 `.claudio/` 中所有匹配的 `skills/*/SKILL.md`，以及匹配的 `.claude/skills/*/SKILL.md` 或 `.agents/skills/*/SKILL.md`。
...
建立 `.claudio/skills/git-release/SKILL.md`，內容如下：
