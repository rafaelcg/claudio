...
- `edit` - Ne mogu modificirati postojeće fajlove, osim fajlova koji se nalaze na `.claudio/plans/*.md` radi detaljiziranja samog plana
...
Kreirajte fajlove načina u `.claudio/modes/` za specifične načine rada ili `~/.config/opencode/modes/` za globalne načine:
