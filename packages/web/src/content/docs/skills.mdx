...
It loads any matching `skills/*/SKILL.md` in `.claudio/` and any matching `.claude/skills/*/SKILL.md` or `.agents/skills/*/SKILL.md` along the way.
...
Create `.claudio/skills/git-release/SKILL.md` like this:
