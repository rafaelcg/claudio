...
- `edit` - Não pode modificar arquivos existentes, exceto para arquivos localizados em `.claudio/plans/*.md` para detalhar o plano em si
...
Crie arquivos de modo em `.claudio/modes/` para modos específicos do projeto ou `~/.config/opencode/modes/` para modos globais:
