...
- `edit` - Kan ikke ændre eksisterende filer, undtagen filer placeret på `.claudio/plans/*.md` for at detaljere selve planen
...
Opret tilstandsfiler i `.claudio/modes/` for projektspecifikke tilstande eller `~/.config/opencode/modes/` for globale tilstande:
