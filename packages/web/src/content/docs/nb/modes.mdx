...
- `edit` - Kan ikke endre eksisterende filer, bortsett fra filer som ligger på `.claudio/plans/*.md` for å detaljere selve planen
...
Opprett modusfiler i `.claudio/modes/` for prosjektspesifikke moduser eller `~/.config/opencode/modes/` for globale moduser:
