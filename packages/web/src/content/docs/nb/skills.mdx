...
- Prosjektkonfigurasjon: `.claudio/skills/<name>/SKILL.md`
...
Den laster alle matchende `skills/*/SKILL.md` i `.claudio/` og alle matchende `.claude/skills/*/SKILL.md` eller `.agents/skills/*/SKILL.md` underveis.
...
Lag `.claudio/skills/git-release/SKILL.md` slik:
