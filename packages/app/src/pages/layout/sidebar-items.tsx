import type { Message, Session, TextPart, UserMessage } from "@claudio-code/sdk/v2/client"
import { Avatar } from "@claudio-code/ui/avatar"
import { HoverCard } from "@claudio-code/ui/hover-card"
...
const CLAUDIO_PROJECT_ID = "4b0ea68d7af9a6031a7ffda7ad66e0cb83315750"
    ...
    <div class={`relative size-8 shrink-0 rounded ${props.class ?? ""}`}>
      <div class="size-full rounded overflow-clip">
        <Avatar
          fallback={name()}
          src={
            props.project.id === CLAUDIO_PROJECT_ID ? "https://opencode.ai/favicon.svg" : props.project.icon?.override
          }
