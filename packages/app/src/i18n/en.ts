export const dict = {
  ...
  "command.language.pick": "Change language",
  "command.language.pick.description": "Choose the interface language",
  ...
  "dialog.provider.claudio.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.claudio.tagline": "Reliable optimized models",
  "dialog.provider.claudioGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Claudio Code",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Claudio Code.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.claudioZen.line1":
    "Claudio Code Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.claudioZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.claudioZen.visit.prefix": "Visit ",
  "provider.connect.claudioZen.visit.link": "opencode.ai/zen",
  "provider.connect.claudioZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Claudio Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Claudio Code.",
  ...
  "dialog.language.description": "Select a language for the interface",
  ...
  "dialog.server.description": "Switch which Claudio Code server this app connects to.",
  ...
  "toast.update.description": "A new version of Claudio Code ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Claudio Code team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Claudio Code does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Claudio Code includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Claudio Code server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Claudio Code",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Claudio Code looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Claudio Code follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Claudio Code is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Claudio Code launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Claudio Code.",
