...
export const dict = {
  ...
  "dialog.provider.claudio.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.claudio.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.claudioGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Claudio Code",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Claudio Code.",
  ...
  "provider.connect.claudioZen.line1":
    "Claudio Code Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.claudioZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.claudioZen.visit.prefix": "Besøk ",
  "provider.connect.claudioZen.visit.link": "opencode.ai/zen",
  "provider.connect.claudioZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Claudio Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Claudio Code.",
  ...
  "dialog.server.description": "Bytt hvilken Claudio Code-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Claudio Code ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Claudio Code-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Claudio Code ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Claudio Code inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Claudio Code-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Claudio Code",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Claudio Code ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Claudio Code skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Claudio Code er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Claudio Code starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Claudio Code.",
