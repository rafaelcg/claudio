export const dict = {
  ...
  "command.language.pick": "Alterar idioma",
  "command.language.pick.description": "Escolher o idioma da interface",
  ...
  "dialog.provider.claudio.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.claudio.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.claudioGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Claudio Code",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Claudio Code.",
  ...
  "provider.connect.claudioZen.line1":
    "Claudio Code Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  "provider.connect.claudioZen.line2":
    "Com uma única chave de API você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.claudioZen.visit.prefix": "Visite ",
  "provider.connect.claudioZen.visit.link": "opencode.ai/zen",
  "provider.connect.claudioZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Claudio Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Claudio Code.",
  ...
  "dialog.language.description": "Selecione um idioma para a interface",
  ...
  "dialog.server.description": "Trocar para qual servidor Claudio Code este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do Claudio Code ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Claudio Code",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Claudio Code ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Claudio Code inclui modelos gratuitos para você começar imediatamente.",
  ...
  "app.name.desktop": "Claudio Code Desktop",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Claudio Code dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Claudio Code",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o Claudio Code aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Claudio Code segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Claudio Code é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Claudio Code iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Claudio Code.",
  ...
  "workspace.type.local": "no computador",
  ...
  "error.page.circular": "[referência circular]",
