export const dict = {
  ...
  "dialog.provider.claudio.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.claudio.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.claudioGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Claudio Code",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Claudio Code-u.",
  ...
  "provider.connect.claudioZen.line1":
    "Claudio Code Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.claudioZen.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.claudioZen.visit.prefix": "Posjeti ",
  "provider.connect.claudioZen.visit.link": "opencode.ai/zen",
  "provider.connect.claudioZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Claudio Code-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Claudio Code-u.",
  ...
  "dialog.server.description": "Promijeni na koji se Claudio Code server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija Claudio Code-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Claudio Code timu",
  ...
  "sidebar.gettingStarted.line1": "Claudio Code uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Claudio Code server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Claudio Code-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako Claudio Code izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Claudio Code prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Claudio Code-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Claudio Code pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Claudio Code-a.",
