...
beforeAll(async () => {
  ...
  mock.module("@claudio-code/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@claudio-code/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@claudio-code/ui/icon", () => ({ Icon: () => null }))
  mock.module("@claudio-code/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
